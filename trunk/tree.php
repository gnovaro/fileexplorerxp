...
<form name="frmMain" id="frmMain" method="post" action="<?=$_SERVER['PHP_SELF'];?>">
  <table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
	  ...
	  <table border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          ...
          <td><a href="javascript:deleteFile('<?=$files[$i]?>');"><img src="<?=URL?>deleteSmall.jpg" style="border:none;" title="Eliminar" /></a></td>
    ...
    <tr bgcolor="#EFEFE9">
      <!-- -->
      <td>&nbsp;<?=$i-2;?>&nbsp;Objetos&nbsp;</td>
      <td align="right"><a href="http://www.novarsystems.com.ar" target="_blank">NovAR Systems - www.novarsystems.com.ar</a>&nbsp;&nbsp;</td>
    </tr>
  </table>
</form>
</body>
