...
//		echo "Path: ".$sPath; //debug
	...
	$editable_files = array('php','pl','js','css','asp','htm','html','xml','c','cpp','ini','log','sql','txt','java','json');
	$previewable_files = array('jpg','jpeg','png','gif','pdf','avi','ogg','mp3','mp4');
?>
<!DOCTYPE html>
<html>
<head>
	...
	<script src="<?php echo URL;?>/assets/js/fexplorer.js"></script>
	<script>
...
<body>
		...
		<div id="divMessage" class="box radius">
			<div style="float:right">
				<a href="#" onclick="close_pop('divMessage');">
					<img src="<?php echo URL;?>/assets/images/close.png" alt="<?php echo I18n::get('Close');?>">
				</a>
			</div>
		...
		<div id="divHelp" class="box" style="display:none;">
			<div style="float:right">
				<a href="#" onclick="$('#divHelp').hide();"><img src="<?php echo URL;?>/assets/images/close.png" alt="<?php echo I18n::get('Close');?>"></a>
			</div>
			<a href="https://github.com/gnovaro/fileexplorerxp" target="_blank">File Explorer XP</a><br />
...
<form name="frmMain" id="frmMain" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>">
	<div id="header-bar">
		<div id="header-bar-title">&nbsp;<?php echo I18n::get('Title');?></div>
		<div id="header-bar-button">
		<a href="#" onclick="close_admin();">
			<img src="<?php echo URL;?>/assets/images/close.png" alt="close" title="<?php echo I18n::get('Exit');?>" /></a>&nbsp;
		</div>
	</div><!--header-bar-->
	...
	<div id="address-bar">
		...
		<a href="#" onclick="FileExplorer.goPath();"><img src="<?php echo URL;?>/assets/images/arrow_go.jpg" alt="<?php echo I18n::get('Go');?>"></a>
		<?php echo I18n::get('Go');?>
	...
	<div id="details">
	  ...
	  <table border="0" cellpadding="0" cellspacing="0" width="100%">
		<tr bgcolor="#EFEFE9">
		  ...
		  <td width="80px"><span class="barra">|</span><?php echo I18n::get('Size');?></td>
		...
		if(is_dir($file)&& $file!='.'):
		?>
			<img src='<?php echo URL?>/assets/images/folder.jpg' alt="">
			&nbsp;
			<a href="tree.php?dir=<?php echo $file;?>" class="menuLeftBar"><?php echo $file;?></a>
		<?php
		else:
				//is file
				...
				if (isset($path_parts['extension'])){
					...
					$sPathIcon = URL."/assets/images/icons/".$ext.".png";
				}
				else //load a generic icon
					$sPathIcon = URL."/assets/images/icons/file.png";
		...
		?>
			<a href="javascript:edit('<?php echo $file?>');"><img src="<?php echo URL?>/assets/images/b_edit.png" alt="<?php echo $CONTENT["EDIT"];?>" title="<?php echo $CONTENT["EDIT"];?>"></a>
		<?php
			elseif(in_array($ext,$previewable_files)):
		?>
			<a onclick="window.open('preview.php?file=<?php echo $file?>')"><img src="<?php echo URL?>/assets/images/zoom.png" alt="Preview"></a>
		<?php
			endif;
		else :
			echo "&nbsp;";
		...
		<td>
			<a href="javascript:rename('<?php echo $file;?>');"><img src="<?php echo URL?>/assets/images/rename.jpg" title="<?php echo $CONTENT["RENAME"];?>" alt="<?php echo $CONTENT["RENAME"];?>"></a>
		</td>
		  <td>
			  <a href="javascript:delete_file('<?php echo $file;?>');"><img src="<?php echo URL?>/assets/images/delete.gif" title="<?php echo $CONTENT["DELETE"];?>" alt="<?php echo $CONTENT["DELETE"];?>"></a>
		  </td>
		  <?php
			  if(is_file($file)){
		  ?>
		  <td>
			  <a href="javascript:compress('<?php echo $file;?>');"><img src="<?php echo URL?>/assets/images/zip.gif" alt="<?php echo $CONTENT["COMPRESS"];?>" title="<?php echo $CONTENT["COMPRESS"];?>"></a>
		  </td>
		  <td>
			  <a onclick="FileExplorer.downloadFile('<?php echo $file?>');"><img src="<?php echo URL?>/assets/images/download.gif" alt="<?php echo $CONTENT["DOWNLOAD"];?>" title="<?php echo $CONTENT["DOWNLOAD"];?>"></a>
		  </td>
		  <?php
		  }//if
		  ?>
